...
QT_MOC_LITERAL(4, 32, 8), // "recvWind"
QT_MOC_LITERAL(5, 41, 11), // "compelCLose"
QT_MOC_LITERAL(6, 53, 12), // "sendOpenInfo"
QT_MOC_LITERAL(7, 66, 15), // "processRecvData"
QT_MOC_LITERAL(8, 82, 11) // "lostconnect"

    },
    "netController\0recvOpenAck\0\0mode\0"
    "recvWind\0compelCLose\0sendOpenInfo\0"
    "processRecvData\0lostconnect"
};
...
void netController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->recvOpenAck((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->recvWind((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 2: _t->compelCLose(); break;
        case 3: _t->sendOpenInfo(); break;
        case 4: _t->processRecvData(); break;
        ...
        {
            typedef void (netController::*_t)(bool );
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&netController::compelCLose)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void netController::recvOpenAck(bool _t1)
{
...
// SIGNAL 1
void netController::recvWind(bool _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void netController::compelCLose()
{
