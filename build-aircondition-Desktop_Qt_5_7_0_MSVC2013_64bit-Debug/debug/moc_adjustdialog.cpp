...
#include "../../aircondition/adjustdialog.h"
...
struct qt_meta_stringdata_AdjustDialog_t {
    QByteArrayData data[1];
    char stringdata0[13];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_AdjustDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AdjustDialog_t qt_meta_stringdata_AdjustDialog = {
    {
QT_MOC_LITERAL(0, 0, 12) // "AdjustDialog"
...
const QMetaObject AdjustDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_AdjustDialog.data,
      qt_meta_data_AdjustDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AdjustDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AdjustDialog.stringdata0))
